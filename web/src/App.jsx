...
function App() {
  ...
  const isCanvasPresentation = layout?.gridDims >= CANVAS_MIN_DIMENSION; const showVisitTrace = layout?.gridDims <= TRACE_MAX_DIMENSION; const gridColumns = layout?.gridDims ?? DEFAULT_GRID_SIZE; const selectedGridDimension = Number(selectedGridDims);
